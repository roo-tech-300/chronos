...
export default function DevPersonaSwitcher() {
  ...
  return (
    <div className="fixed bottom-4 left-4 z-[70] flex items-center gap-2 bg-zinc-900/95 backdrop-blur-md text-white px-3 py-2 rounded-full border border-zinc-700/60 shadow-2xl transition-all duration-200">
